...
export const GET_HOME_ACTIVITYLIST_SUCCESS = 'GET_HOME_ACTIVITYLIST_SUCCESS' //取得首頁活動列表成功
export const GET_HOME_ACTIVITYLIST_FAILURE = 'GET_HOME_ACTIVITYLIST_FAILURE' //取得首頁活動列表失敗
